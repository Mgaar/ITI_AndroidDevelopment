...
int currentsize;
public:
DynamicArray():ptr{new int},capacity{1},currentsize{0}{}
DynamicArray(int capacity):ptr{new int[capacity]},capacity{capacity},currentsize{0}{}
DynamicArray(int capacity,int value):ptr{new int[capacity]{value}},capacity{capacity},currentsize{capacity}{}
DynamicArray(int capacity,std::initializer_list <int> list):ptr{new int[capacity]},capacity{capacity},currentsize{capacity}
{
    int j=0;
    for (auto i:list)
    {
...
DynamicArray arr;
DynamicArray arr2(5);
DynamicArray arr3(5,0);
DynamicArray arr4(3,{1,2,4});
arr4.print();
std::cout<<"\n";
arr3.print();
std::cout<<"\n";
